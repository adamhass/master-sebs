#!/usr/bin/env python3
"""Aggregate Gresse HTTP bench outputs into collected_metrics.json."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Collect Gresse benchmark metrics from a run directory.")
