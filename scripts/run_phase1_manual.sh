...
./sebs.py experiment invoke perf-cost --config config/phase1/cloudburst-stateful/perf-cost-c1.json --deployment aws --output-dir phase1-results/cloudburst-stateful/c1
./sebs.py experiment process perf-cost --config config/phase1/cloudburst-stateful/perf-cost-c1.json --deployment aws --output-dir phase1-results/cloudburst-stateful/c1

./sebs.py experiment invoke perf-cost --config config/phase1/cloudburst-stateful/perf-cost-c10.json --deployment aws --output-dir phase1-results/cloudburst-stateful/c10
./sebs.py experiment process perf-cost --config config/phase1/cloudburst-stateful/perf-cost-c10.json --deployment aws --output-dir phase1-results/cloudburst-stateful/c10

./sebs.py experiment invoke perf-cost --config config/phase1/cloudburst-stateful/perf-cost-c50.json --deployment aws --output-dir phase1-results/cloudburst-stateful/c50
./sebs.py experiment process perf-cost --config config/phase1/cloudburst-stateful/perf-cost-c50.json --deployment aws --output-dir phase1-results/cloudburst-stateful/c50

./sebs.py experiment invoke perf-cost --config config/phase1/cloudburst-stateful/perf-cost-c100.json --deployment aws --output-dir phase1-results/cloudburst-stateful/c100
./sebs.py experiment process perf-cost --config config/phase1/cloudburst-stateful/perf-cost-c100.json --deployment aws --output-dir phase1-results/cloudburst-stateful/c100
